...
public class PillarEntityRenderer  extends TileEntitySpecialRenderer {
	public static String textureFile = "/images/marble_pillar.png";
	private final ModelPillar model;

	public PillarEntityRenderer() {
		model = new ModelPillar();
	}

	public void renderAModelAt(PillarEntity tile, double d, double d1, double d2, float f) {
		bindTextureByName(textureFile);
	...
	public void renderTileEntityAt(TileEntity tileentity, double d, double d1, double d2, float f) {
		renderAModelAt((PillarEntity) tileentity, d, d1, d2, f); //where to render
	}
}
